...
class LlamaDecoderLayer(nn.Module):
    def __init__(
        ...
        config: LlamaConfig,
        linear_method: Optional[LinearMethodBase] = None,
        norm: type[torch.nn.Module] = RMSNorm,
    ) -> None:
        super().__init__()
...
class LlamaModel(nn.Module):
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [LlamaDecoderLayer(config, linear_method, norm=norm) for _ in range(config.num_hidden_layers)]
        )
...
class LlamaForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self.model = LlamaModel(config, linear_method, lora_config=lora_config, norm=norm)
