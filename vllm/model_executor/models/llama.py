...
from vllm.model_executor.layers.recogni_rms_norm import RecogniRMSNorm
...
class LlamaModel(nn.Module):
    def __init__(
        ...
        *,
        ...
        if vllm_config.norm is None:
            logger.info("Use casual RMS Norm.")
            norm = RMSNorm
        elif vllm_config.norm.lower() == "recogni":
            logger.info("Use Recogni RMS Norm.")
            norm = RecogniRMSNorm
        else:
            raise ValueError(f"Unsupported norm type: {vllm_config.norm}")
